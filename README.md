...
:----|:----
`/`|[The root of the API](https://github.com/sonata-nfv/tng-gtk-vnv/wiki/other-endpoints#root)
`/pings`|[The module's `readiness` and `liveness` endpoint](https://github.com/sonata-nfv/tng-gtk-vnv/wiki/other-endpoints#pings)
