...
//            sh 'git clone https://github.com/sonata-nfv/tng-devops.git'
//            dir(path: 'tng-devops') {
//              sh 'ansible-playbook roles/sp.yml -i environments -e "target=int-vnv component=gatekeeper"'
//            }
          }
        }
      }
    ...
    stage('Promoting release v5.0') {
      ...
      stages {
        stage('Generating release') {
          steps {
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-vnv:latest registry.sonata-nfv.eu:5000/tng-gtk-vnv:v5.0'
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-gtk-vnv:latest sonatanfv/tng-gtk-vnv:v5.0'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-gtk-vnv:v5.0'
            sh 'docker push sonatanfv/tng-gtk-vnv:v5.0'
          }
        }
